...
sm = Studio.create(name: "Santa Monica")
...
pope = User.create(username: "UbiPope", password: "movingon", studio: ubi)
...
smk = User.create(username: "corynumba1", password: "corykratos", studio: sm)
...
gow = Game.create(title: "God of War", studio: sm, genre: "Action", submitted_by: smk.username, description: "As a god, Kratos must be strong. As a father, he must become stronger", user_id: smk.id)